...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_CCLIENTE: 'cCliente/PARTIAL_UPDATE_CCLIENTE',
...
export default (state: CClienteState = initialState, action): CClienteState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_CCLIENTE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_CCLIENTE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_CCLIENTE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<ICCliente> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_CCLIENTE,
