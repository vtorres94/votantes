...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, mx.com.morena.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, mx.com.morena.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, mx.com.morena.domain.CAgenda.class.getName());
