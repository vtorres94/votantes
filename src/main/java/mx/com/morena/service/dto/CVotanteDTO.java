...
/**
 * A DTO for the {@link mx.com.morena.domain.CVotante} entity.
 */
public class CVotanteDTO implements Serializable {
    ...
    private CDefensorVotoDTO defensorVoto;
    ...
    public CDefensorVotoDTO getDefensorVoto() {
        return defensorVoto;
    }

    public void setDefensorVoto(CDefensorVotoDTO defensorVoto) {
        this.defensorVoto = defensorVoto;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CVotanteDTO)) {
            return false;
        }

        CVotanteDTO cVotanteDTO = (CVotanteDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, cVotanteDTO.id);
    }
