...
/**
 * Criteria class for the {@link mx.com.morena.domain.CDefensorVoto} entity. This class is used
 * in {@link mx.com.morena.web.rest.CDefensorVotoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /c-defensor-votos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CDefensorVotoCriteria implements Serializable, Criteria {
    ...
    public CDefensorVotoCriteria() {}

    public CDefensorVotoCriteria(CDefensorVotoCriteria other) {
    ...
    @Override
    public CDefensorVotoCriteria copy() {
        return new CDefensorVotoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CDefensorVotoCriteria that = (CDefensorVotoCriteria) o;
        return (
